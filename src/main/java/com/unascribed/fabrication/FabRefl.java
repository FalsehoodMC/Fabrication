...
public class FabRefl {
	...
	private static MethodHandle cpc2sp_channel = unreflectGetter(CustomPayloadC2SPacket.class, "channel", "field_12830", "field_149562_a");
	...
	private static MethodHandle cpc2sp_data = unreflectGetter(CustomPayloadC2SPacket.class, "data", "field_12832", "field_149561_c");
	...
	private static MethodHandle tacs_entityTrackers = unreflectGetter(ThreadedAnvilChunkStorage.class, "entityTrackers", "field_18242", "field_219272_z");
	...
	private static MethodHandle et_playersTracking = unreflectGetter(EntityTracker.class, "playersTracking", "field_18250", "field_219406_f");
	...
	private static MethodHandle rpm_providers_get = unreflectGetter(ResourcePackManager.class, "providers", "field_14227", "field_198987_a");
	...
	private static MethodHandle rpm_providers_set = unreflectSetter(ResourcePackManager.class, "providers", "field_14227", "field_198987_a");
	...
	private static MethodHandle me_getDropChance = unreflectMethod(MobEntity.class, "getDropChance", "method_5929", "func_205712_c",
			float.class,
			EquipmentSlot.class);
