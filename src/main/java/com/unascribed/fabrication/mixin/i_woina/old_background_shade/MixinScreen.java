...
public class MixinScreen {
	...
	@FabModifyConst(constant=@Constant(intValue=-1072689136), method="renderBackground(Lnet/minecraft/client/gui/DrawContext;)V")
	public int modifyTopBgColor(int color) {
		if (!FabConf.isEnabled("*.old_background_shade")) return color;
		return 0x60050500;
	}

	@FabModifyConst(constant=@Constant(intValue=-804253680), method="renderBackground(Lnet/minecraft/client/gui/DrawContext;)V")
