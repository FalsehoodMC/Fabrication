...
public abstract class MixinCakeBlock {
	...
	private static boolean fabrication$noHunger$eatCake(HungerManager hungerManager, int hunger, float saturation, CakeBlock block, WorldAccess world, BlockPos pos, BlockState state, PlayerEntity player) {
