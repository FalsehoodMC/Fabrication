...
public class FeatureFoliageCreepers extends ResourcePackFeature {
	...
	public void register(Consumer<ResourcePackProfile> consumer) {
		consumer.accept(ResourcePackProfile.of(MixinConfigPlugin.MOD_NAME + " grayscale", Text.literal("Internal " + MixinConfigPlugin.MOD_NAME + " grayscale resources"), true,
				...
				new ResourcePackProfile.Metadata(Text.of(MixinConfigPlugin.MOD_NAME+" internal pack"), 12, null), ResourceType.CLIENT_RESOURCES, ResourcePackProfile.InsertionPosition.TOP, false, ResourcePackSource.BUILTIN));
	}
	@Override
	public void apply() {
	}
