...
public abstract class MixinLivingEntity {
	...
	private static final Predicate<List<?>> fabrication$shieldStaggerPredicate = ConfigPredicates.getFinalPredicate("*.interrupting_damage");
	...
	public void brittleShield(DamageSource source, float amount, CallbackInfoReturnable<Boolean> cir) {
		if (!(FabConf.isEnabled("*.shield_cooldown") && fabrication$shieldStaggerPredicate.test(ImmutableList.of(this, source)))) return;
		Object self = this;
