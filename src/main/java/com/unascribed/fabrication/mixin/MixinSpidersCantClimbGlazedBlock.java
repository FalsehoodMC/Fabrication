...
public abstract class MixinSpidersCantClimbGlazedBlock extends HorizontalFacingBlock {
	...
	public VoxelShape getCollisionShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
		if (RuntimeChecks.check("*.spiders_cant_climb_glazed_terracotta") && context instanceof IsSpider && ((IsSpider)context).fabrication$isSpider()) {
	...
	public void onEntityCollision(BlockState state, World world, BlockPos pos, Entity entity) {
		...
		if (RuntimeChecks.check("*.spiders_cant_climb_glazed_terracotta") && entity instanceof SetSlippery) {
