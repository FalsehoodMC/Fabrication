...
public class MixinItemEntityRenderer {
	...
	public void render(ItemEntity entity, float a, float b, MatrixStack matrices, VertexConsumerProvider vertexConsumerProvider, int i, CallbackInfo ci) {
		...
		BakedModel bm = this.itemRenderer.getHeldItemModel(stack, entity.world, null);
		if (bm.hasDepth() && stack.getItem() != Items.TRIDENT) return;
		...
		BakedModel bakedModel = this.itemRenderer.getHeldItemModel(entity.getStack(), entity.world, null);
