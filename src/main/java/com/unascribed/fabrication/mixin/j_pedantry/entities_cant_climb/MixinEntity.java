...
public class MixinEntity {
	...
	@ModifyReturn(method="move(Lnet/minecraft/entity/MovementType;Lnet/minecraft/util/math/Vec3d;)V", target="Lnet/minecraft/block/BlockState;isIn(Lnet/minecraft/tag/Tag;)Z")
	private static boolean fabrication$disableClimbing(boolean old, BlockState state, Tag<Block> tag, Entity entity) {
