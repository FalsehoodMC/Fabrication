...
public abstract class MixinItemStack {
	...
	public void use(World world, PlayerEntity user, Hand hand, CallbackInfoReturnable<TypedActionResult<ItemStack>> cir) {
		...
		if (tag == null) return;
		NbtCompound lTag = tag.getCompound("fabrication#conflictingEnchants");
		...
		if (!currentConflicts.isEmpty() && user.isSneaky()) {
			...
			if (tag.isEmpty()) {
				this.tag.remove("fabrication#conflictingEnchants");
			} else {
				this.tag.put("fabrication#conflictingEnchants", tag);
			}
