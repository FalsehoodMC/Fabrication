...
public class MixinItemRenderer {
	...
	private static HijackReturn blink(ItemStack stack){
		if (!FabConf.isEnabled("*.blinking_drops") || stack.getItem() instanceof BlockItem || BlinkingDropsOverlay.renderLayerFunction == null) return null;
		return new HijackReturn(BlinkingDropsOverlay.renderLayerFunction);
	}
